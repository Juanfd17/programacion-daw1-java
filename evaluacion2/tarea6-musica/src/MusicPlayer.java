public class MusicPlayer {
    ...
    public MusicPlayer(MusicStorageSystemA musicStorageSystemA) {
        this.musicStorage = musicStorageSystemA;
    }

    public MusicPlayer(MusicStorageSystemB musicStorageSystemB) {
        this.musicStorage = musicStorageSystemB;
    }
